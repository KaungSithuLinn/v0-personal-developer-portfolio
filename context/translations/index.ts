...
const translations: TranslationsType = {
  en: {
    ...
    "about.paragraph2": "My recent research focuses on cutting-edge behavioral biometrics and fraud detection using machine learning. I'm also certified in digital marketing fundamentals, allowing me to bridge technical development with effective market strategies. I hold a Master's in Information Technology (Business Informatics) from James Cook University Singapore, where I deepened my expertise in data analytics and AI applications.",
    ...
    "contact.form.consent": "I agree to be contacted at the email address I provided regarding my message. I will not store or share your information.",
    ...
    "console.advanced": "Open advanced developer console",
    "console.advancedHide": "Close advanced developer console",
    "systemMonitor.cpuUsage": "CPU Usage",
    "systemMonitor.hide": "Hide system monitor",
    "systemMonitor.memoryUsage": "Memory Usage",
    "systemMonitor.networkActivity": "Network Activity",
    "systemMonitor.show": "Show system monitor",
    ...
    "testimonials.goto": "Go to testimonial {number} of {total}",
  ...
  zh: {
    ...
    "about.paragraph2": "我最近的研究专注于使用机器学习的前沿行为生物识别和欺诈检测。我还获得了数字营销基础认证，使我能够将技术开发与有效的市场策略相结合。我持有新加坡詹姆斯库克大学信息技术（商业信息学）硕士学位，在那里我深化了在数据分析和人工智能应用方面的专业知识。",
    ...
    "contact.form.consent": "我同意就我的消息使用我提供的电子邮箱地址进行联系。我不会存储或分享您的信息。",
    ...
    "projects.empty": "此分类下暂无项目。",
    "projects.filter.label": "按类别筛选项目",
    "projects.filter.all": "全部",
    "projects.filter.research": "研究",
    "projects.filter.ml": "机器学习",
    "projects.filter.security": "安全",
    "services.api": "API开发",
    ...
    "console.advanced": "打开高级开发者控制台",
    "console.advancedHide": "关闭高级开发者控制台",
    "systemMonitor.cpuUsage": "CPU 使用率",
    "systemMonitor.hide": "隐藏系统监控",
    "systemMonitor.memoryUsage": "内存使用率",
    "systemMonitor.networkActivity": "网络活动",
    "systemMonitor.show": "显示系统监控",
    ...
    "testimonials.goto": "前往推荐{number}/{total}",
  ...
  ms: {
    ...
    "about.paragraph2": "Penyelidikan terkini saya fokus pada biometrik tingkah laku dan pengesanan penipuan menggunakan pembelajaran mesin. Saya juga mempunyai sijil dalam asas pemasaran digital, membolehkan saya menghubungkan pembangunan teknikal dengan strategi pasaran yang berkesan. Saya memegang Sarjana dalam Teknologi Maklumat (Informatik Perniagaan) dari James Cook University Singapore, di mana saya mendalami kepakaran dalam analisis data dan aplikasi AI.",
    ...
    "contact.form.consent": "Saya bersetuju untuk dihubungi di alamat e-mel yang saya berikan berhubung mesej saya. Saya tidak akan menyimpan atau berkongsi maklumat anda.",
    ...
    "projects.empty": "Tiada projek dalam kategori ini buat masa sekarang.",
    "projects.filter.label": "Tapis projek mengikut kategori",
    "projects.filter.all": "Semua",
    "projects.filter.research": "Penyelidikan",
    "projects.filter.ml": "Pembelajaran Mesin",
    "projects.filter.security": "Keselamatan",
    ...
    "console.advanced": "Buka konsol pembangun lanjutan",
    "console.advancedHide": "Tutup konsol pembangun lanjutan",
    "systemMonitor.cpuUsage": "Penggunaan CPU",
    "systemMonitor.hide": "Sembunyikan Monitor Sistem",
    "systemMonitor.memoryUsage": "Penggunaan Memori",
    "systemMonitor.networkActivity": "Aktiviti Rangkaian",
    "systemMonitor.show": "Tunjukkan Monitor Sistem",
    ...
    "terminal.show": "Tunjukkan terminal",
    "terminal.hide": "Sembunyikan terminal",
    ...
    "testimonials.goto": "Pergi ke testimoni {number} daripada {total}",
