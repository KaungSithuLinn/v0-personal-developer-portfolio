...
export function generateHrefLangTags(alternates: LanguageAlternate[]): ReactElement[] {
...
export function generateLanguageMetaTags(language: Language): ReactElement[] {
  return [
    <meta
...
export function generateRTLMetaTags(isRTL: boolean): ReactElement[] {
  if (!isRTL) return []
